<template>
  <footer class="bg-black bg-opacity-50 text-emerald-500">
    ...
    >
      ...
      <div class="flex flex-col mt-8 md:order-1 md:mt-0 opacity-100">
...
const navigation = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/andrea.raccagni',
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/yozen81',
    icon: defineComponent({
      render: () =>
        h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
          h('path', {
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/AndreaRaccagni',
    icon: defineComponent({
      render: () =>
        h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
          h('path', {
  ...
  {
    name: 'GitLab',
    href: 'https://gitlab.com/AndreaRaccagni',
    icon: defineComponent({
      render: () =>
        h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
          h('path', {
